...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('realestate_woningobject', 'zip_code', self.gf('cms.utils.models.NLZipCodeField')(default=1000, max_length=7), keep_default=False)
    ...
    models = {
        'realestate.woningobject': {
            ...
            'zip_code': ('cms.utils.models.NLZipCodeField', [], {'max_length': '7'})
        }
    }
