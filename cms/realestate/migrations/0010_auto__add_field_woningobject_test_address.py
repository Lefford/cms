...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WoningObject.test_address'
        db.add_column('realestate_woningobject', 'test_address', self.gf('cms.utils.models.LocationMultiValueField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WoningObject.test_address'
        db.delete_column('realestate_woningobject', 'test_address')
    ...
    models = {
        'realestate.woningobject': {
            ...
            'test_address': ('cms.utils.models.LocationMultiValueField', [], {'null': 'True'}),
